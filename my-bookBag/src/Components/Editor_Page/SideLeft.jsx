...
class SideLeft extends Component {
  constructor(props){
    super(props)
    this.middleScreen = <MiddleScreen name="Chemistry"/>
  ...
  handleCompChange(){
    alert("This would open up your Computer Science notebook!");
  }

  handleBioChange(){
    alert("This would open up your Biology notebook!");
  }
  handleEconChange(){
    alert("This would open up your Economics notebook!");
  }
      ...
      <div class="wrapper">
          <nav id="sidebar">
              ...
              <ul class="list-unstyled components">
                  <li class="active">
                      <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" onClick={this.handleChemChange} >Chemistry</a>
